...
def write_sample(noisy_audio_tensor, clean_audio_tensor, cleaned_audio_tensor, batch, sample, epoch):
  root = "sample_data_no_disentangle_L1Loss_Scheduler_500steps_2Speaker"
...
loss_filename = 'loss_high_res_no_disentangle_L1Loss_Scheduler_2Speaker.txt'
model_weights_path = 'model_weights_high_res_no_disentangle_L1Loss_Scheduler_2Speaker.pth'
